...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		KC_LSFT, KC_NUBS, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_LSFT, M(0), KC_NO, 
		KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, RGUI(KC_NO), KC_MENU, KC_LCTL, KC_NO, KC_NO, KC_NO),
